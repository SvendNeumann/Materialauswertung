...
- Rechnungsupload mit Supabase-Speicherung, Statusworkflow und Dublettenhinweis
...
- Artikelpreisvergleich, Standortanalyse, Lieferantenbewertung und Warenkorbanalyse
- Priorisierte A/B/C-Empfehlungen mit Standortleiter-Ansicht
- Report-Center mit PDF-Druckansicht und CSV/Excel-Export
- Supabase-Import echter PDF-Rechnungen mit Lieferantenprofilen fuer Henry Schein, GERL und Plandent
...
Das Skript kann PDF-Rechnungen lokal strukturieren. Die App selbst liest die freigegebenen Importdaten aus Supabase.
